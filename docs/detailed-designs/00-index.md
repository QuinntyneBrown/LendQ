...
This document is the entry point for the full detailed design set for LendQ. The target implementation is an Angular SPA with Angular Material, an ASP.NET Core 8 Web API, PostgreSQL for system of record data, Redis for cache and coordination, .NET BackgroundService workers for asynchronous processing, and an OpenAPI contract used as the integration source of truth.
...
|---|---|
| Client architecture | Angular SPA with lazy-loaded feature modules, injectable HttpClient services for server state, Reactive Forms for input validation, Angular Material for the component library, and a shared responsive component system derived from `docs/ui-design.pen`. |
...
| Notification delivery | Domain events are written to a transactional outbox. .NET BackgroundService workers deliver in-app and email notifications, deduplicate by event and channel, and fan out in-app updates over Server-Sent Events. |
...
| [07-fe-architecture.md](07-fe-architecture.md) | Angular SPA architecture, route protection, responsive shell, accessibility, performance budgets |
| [08-fe-authentication.md](08-fe-authentication.md) | Angular auth flows, bootstrap, verify-email, reset-password, session-expiry UX |
| [09-fe-user-management.md](09-fe-user-management.md) | Angular admin user and role UX, audit search, revocation behavior |
| [10-fe-loan-management.md](10-fe-loan-management.md) | Angular loan list/detail UX, governed edits, schedule builder, borrower change requests |
| [11-fe-payment-tracking.md](11-fe-payment-tracking.md) | Angular payment entry, allocation preview, reversal UX, schedule-adjustment UX |
| [12-fe-dashboard.md](12-fe-dashboard.md) | Angular dashboard UX, freshness indicators, independent section loading and recovery |
| [13-fe-notifications.md](13-fe-notifications.md) | Angular notification bell, list, SSE updates, toasts, reconciliation behavior |
| [14-fe-settings-preferences.md](14-fe-settings-preferences.md) | Angular settings screens for notification preferences and session/security controls |
